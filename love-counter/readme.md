...
<p align="center">
  <img src="./docs/images/あいさつ1.png" width="400" alt="ウェルカムメッセージ1">
  <img src="./docs/images/あいさつ2.png" width="400" alt="ウェルカムメッセージ2">
</p>
...
<p align="center">
  <img src="./docs/images/ねえねえ応答1.png" width="400" alt="キーワード自動応答1">
  <img src="./docs/images/ねえねえ応答2.png" width="400" alt="キーワード自動応答2">
</p>
...
- ✅ **フェーズ1**: 基本機能（ランダムメッセージ、カウント、特別メッセージ）- 完了: 2025-12-04
- ✅ **フェーズ2**: Apple風デザイン（SVGりんごボタン、洗練されたUI）- 完了: 2025-12-04
- ✅ **フェーズ3**: LINE連携機能（LIFF実装、画像送信、返信フォーム）- 完了: 2025-12-11
